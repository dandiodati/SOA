 ...
 */
public class SOAMessageType extends ManagerMessage {

   /**
    * This is the key used to get the message definition
    * from the repository.
    */
   public static final String SOA_MESSAGE_TYPE = "soa";
   ...
   /**
    * The name of the column that will contain the region to which the message
    * belongs.
    */
   ...
   /**
    * The region to which this message belongs.
    */
   ...
   private static SQLColumn[] columns =
   {
       ...
       new SQLColumn ( REGION_COL, SQLColumn.INT_TYPE )
   };
   ...
   public void setValues ( Map map ) throws QueueException
   {
      ...
      region  = (Integer) map.get( REGION_COL );
    ...
    /**
     * Access the Region associated with the message. Could be null.
     *
     * @return String the region index.
     */
