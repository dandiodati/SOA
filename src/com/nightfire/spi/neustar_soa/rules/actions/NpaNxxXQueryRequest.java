/**
 * This is the class which is used to generate NpaNxxXQueryRequest xml.
 *
 * @author Devaraj
 * @version 1.0
...
public class NpaNxxXQueryRequest extends Action {
   
	/**
	 * Constructor for NpaNxxXQuery Request which will 
	 * inturn call the super class constructor.
	 */
    public NpaNxxXQueryRequest(){

      	super( SOAConstants.NPANXXX_QUERY_REQUEST );     
