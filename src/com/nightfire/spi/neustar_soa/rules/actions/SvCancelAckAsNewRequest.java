...
public class SvCancelAckAsNewRequest extends SVAction{

   public static final String BASE_PATH = SOAConstants.REQUEST_BODY_PATH+"."+
                                          SOAConstants.SV_CANCEL_AS_NEW_REQUEST+
   ...
   public SvCancelAckAsNewRequest(){

      super( SOAConstants.SV_CANCEL_AS_NEW_REQUEST,
             SVID_LOCATION,
             REGION_LOCATION,
             TN_LOCATION );
