...
public class SvCancelAckAsOldRequest extends SVAction{

   public static final String BASE_PATH = SOAConstants.REQUEST_BODY_PATH+"."+
                                          SOAConstants.SV_CANCEL_AS_OLD_REQUEST+
   ...
   public SvCancelAckAsOldRequest(){

      super( SOAConstants.SV_CANCEL_AS_OLD_REQUEST,
             SVID_LOCATION,
             REGION_LOCATION,
             TN_LOCATION );
