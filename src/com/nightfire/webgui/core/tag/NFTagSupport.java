...
/**
 * Base class which all non-body tags need to extend. Provides common
 * configuration support, such as logging configuration.
 * Each tag must call the setup method in there doStartTag method, if 
 * they overload the doStarTag method.
 */
public abstract class NFTagSupport extends TagSupport
{
     ...
     * @return SKIP_BODY is returned so that the body is NOT evaluated.
     */
     ...
     *
     * This method should NOT be used for Java Objects. e.g. String.
     * This is because Tomcat 5.5 has implicit support for Expression Language and
     * hence if any String tag parameter is passed, its value will be evaluated automatically.
     * 
