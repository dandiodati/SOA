REM $Header: //nfcommon/R4.4/com/nightfire/servers/CosEvent/test/testPushConsumer.bat#1 $
...
vbj -DORBservices=CosNaming -DSVCnameroot=Nightfire -classpath %CLASSPATH% com.nightfire.servers.CosEvent.test.TestPushConsumer %1
